...
<div class="cl_dialog change_icon" id="cl_dialog_change_icon">
    ...
    <div class="icons-wrapper">
        <?php $icons_array = Codeless_Icons::get_icons(); $icons_array = $icons_array['Codeless Icons']; ?>
        <?php  foreach( $icons_array as $icon ): ?>
            <?php  foreach( $icon as $icon_key => $icon_value ): ?>
            <div class="icon" data-value="<?php echo $icon_key ?>">
                
                <i class="<?php echo $icon_key ?>"></i>
